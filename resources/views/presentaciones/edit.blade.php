...
@section('content')
 <main>
    <div class="container mx-auto px-4 py-8">
        <h2 class="text-2xl font-semibold mb-6">Editar presentación</h2> 
        ...
        @endif
            ...
            <form action="{{ route('presentaciones.update', $presentacion->id_presentacion) }}" method="POST" class="max-w-md mx-auto">
                @csrf
                @method('PUT')
                <div class="relative z-0 w-full mb-5 group">
                    <select name="id_producto" id="id_producto" value="{{$presentacion->id_producto}}"
                    ...
                    <div class="relative z-0 w-full mb-5 group">
                        <input type="text" name="nombre_presentacion" id="nombre_presentacion" value="{{ $presentacion->nombre_presentacion }}"
                ...
                <div class="grid md:grid-cols-2 md:gap-6">
                    <div class="relative z-0 w-full mb-5 group">
                    <select name="cantidad_unitaria" id="cantidad_unitaria" value="{{ $presentacion->cantidad_unitaria }}"
                        class="block py-2.5 px-0 w-full text-sm text-heading bg-transparent border-0 border-b-2 border-default-medium appearance-none focus:outline-none focus:ring-0 focus:border-brand peer">
                    ...
                    <div class="relative z-0 w-full mb-5 group">
                        <input type="number" name="cantidad_caja" id="cantidad_caja"  maxlength="5" value="{{ $presentacion->cantidad_caja }}"
                        class="block py-2.5 px-0 w-full text-sm text-heading bg-transparent border-0 border-b-2 border-default-medium appearance-none focus:outline-none focus:ring-0 focus:border-brand peer" placeholder=" " required />
                    ...
                    <div class="grid md:grid-cols-2 md:gap-6">
                    <div class="relative z-0 w-full mb-5 group">
                        <input type="number" name="precio_unidad" id="precio_unidad" maxlength="10" value="{{ $presentacion->precio_unidad }}"
                        class="block py-2.5 px-0 w-full text-sm text-heading bg-transparent border-0 border-b-2 border-default-medium appearance-none focus:outline-none focus:ring-0 focus:border-brand peer" placeholder=" " required />
                ...
                <div class="relative z-0 w-full mb-5 group">
                    <input type="number" name="precio_caja" id="precio_caja" maxlength="10" value="{{ $presentacion->precio_caja }}"
                    class="block py-2.5 px-0 w-full text-sm text-heading bg-transparent border-0 border-b-2 border-default-medium appearance-none focus:outline-none focus:ring-0 focus:border-brand peer" placeholder=" " required />
                ...
                <div class="relative z-0 w-full mb-5 group">
                    <select name="estado" id="estado" value="{{ $presentacion->estado }}"
                        class="block py-2.5 px-0 w-full text-sm text-heading bg-transparent border-0 border-b-2 border-default-medium appearance-none focus:outline-none focus:ring-0 focus:border-brand peer">
